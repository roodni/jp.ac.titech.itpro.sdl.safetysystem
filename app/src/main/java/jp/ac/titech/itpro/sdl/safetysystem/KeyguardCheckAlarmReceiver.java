...
public class KeyguardCheckAlarmReceiver extends BroadcastReceiver {
    ...
    public static void setAlarmLoop(Context context, long nextMillis) {
        ...
        alarmManager.set(AlarmManager.ELAPSED_REALTIME, SystemClock.elapsedRealtime() + nextMillis, sender);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (isSafetyNotifyActive) {
            ...
            if (keyguardManager.isKeyguardLocked()) {
                ...
                setAlarmLoop(context, 3000);    // 3 sec
            } else {
                // ロックが解除されている
                ...
                editor.apply();
                setAlarmLoop(context, 60 * 1000); // 1 min
            }
        } else {
